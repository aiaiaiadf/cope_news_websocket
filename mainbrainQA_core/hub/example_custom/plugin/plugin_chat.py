...
from common.utils import show_lg,show_db,getLatestDirectory
from common.llm_utils import str2dict,duplicate_removal,getLastMsg
...
class Greet(PluginBase):
    def process(self,state):
        # show_db("AnalysisQuery")
        d = getLatestDirectory(chat_history)
        if d is None:
            ...
        else:
            msg = getLastMsg(d)
