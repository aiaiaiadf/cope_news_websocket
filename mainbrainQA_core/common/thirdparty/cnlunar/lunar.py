...
from common.thirdparty.cnlunar.config import *
from common.thirdparty.cnlunar.holidays import otherLunarHolidaysList, otherHolidaysList, legalsolarTermsHolidayDic, legalHolidaysDic, \
    legalLunarHolidaysDic
from common.thirdparty.cnlunar.solar24 import getTheYearAllSolarTermsList
from common.thirdparty.cnlunar.tools import sortCollation, rfRemove, rfAdd
